  ...
  Widget build(BuildContext context) {
    return Theme(
      ...
      child: Form(
        ...
        child: Scaffold(
          appBar: AppBar(
            leading:MaterialButton(onPressed: (){},child: Icon(Icons.arrow_back,size: 30,color: Colors.black,weight: 100),),centerTitle: true ,title: Text("HOME",style: TextStyle(fontSize: 23,color: Colors.black,fontWeight:FontWeight.w800 ),),
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Image(
                      image:NetworkImage("https://th.bing.com/th/id/OIP.oC1A7RzPRbwrtpxo8fUVZgAAAA?w=137&h=180&c=7&r=0&o=5&dpr=1.4&pid=1.7")
